# Model Metadata: PatientCareGivingSystem_SmartHome

| Label | Description |
| :--- | :--- |
| **title** | PatientCareGivingSystem_SmartHome|
| **source_paper** | Reasoning with contextual requirements: Detecting inconsistency and conflicts |
