# Model Metadata: RetrievalBased_Chatbot

| Label | Description |
| :--- | :--- |
| **title** | RetrievalBased_Chatbot |
| **source_paper** |Chatbot Design - Reasoning about design options using i* and proces architecture |
| **DOI** |https://ceur-ws.org/Vol-1829/iStar17_paper_7.pdf |
| **authors** | Z. Babar, A. Labouchnian, E. Yu |
| **year** | 2017 |
