# Model Metadata: HearingAids_SaleAndDistribution_SPL

| Label | Description |
| :--- | :--- |
| **title** | HearingAids_SaleAndDistribution_SPL |
| **source_paper** | From goal models to feature models: A rule-based approach for software product lines |
| **DOI** | 10.1109/APSEC.2015.22 |
| **authors** | D. Yu, Z. Yhen, Y. Zhang |
| **year** | 2016 |
