# Model Metadata: OnlineCustomerOrder_ProcessingSystem

| Label | Description |
| :--- | :--- |
| **title** | OnlineCustomerOrder_ProcessingSystem |
| **source_paper** |Ensuring consistency among business goals and business process models |
| **DOI** | 10.1109/EDOC.2013.12|
| **authors** |B. Nagel, C. Gerth, G. Engels, J. Post |
| **year** | 2013 |
| **domain** |E-Commerce|
