# Model Metadata: BTW_RouteAdviceAndNavigation

| Label | Description |
| :--- | :--- |
| **title** | BTW_RouteAdviceAndNavigation |
| **source_paper** | Changing attitudes towards the generation of architectual models|
