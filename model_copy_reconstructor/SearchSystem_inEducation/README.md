# Model Metadata: SearchSystem_inEducation

| Label | Description |
| :--- | :--- |
| **title** | SearchSystem_inEducation |
| **source_paper** |A design framework for generating BDI-agents from goal models |
| **DOI** | 10.1145/1329125.1329307|
| **authors** | L. Penserini, A. Perini, A. Susi, M. Morandini, J. Mylopoulos|
| **year** | 2007 |
| **domain** | Education |
