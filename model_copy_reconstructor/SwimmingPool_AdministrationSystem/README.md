# Model Metadata: SwimmingPool_AdministrationSystem

| Label | Description |
| :--- | :--- |
| **title** | SwimmingPool_AdministrationSystem |
| **source_paper** | Risk-aware decision support with constrained goal models |
| **DOI** |10.1108/ICS-01-2018-0010 |
| **authors** |N. Argyropoulos,  K. Angelopoulos, H. Mouratidis,  A. Fish,|
| **year** | 2018|
