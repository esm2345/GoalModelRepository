# Model Metadata: SmartHomeSystem_assistedLiving


| Label | Description |
| :--- | :--- |
| **title** | SmartHomeSystem_assistedLiving|
| **source_paper** | Deriving Software architectural models from requirements models for adaptive systems: The STREAM-A approach |
| **DOI** |10.1007/s00766-011-0126-z |
| **authors** | J. Pimentel, M. Lucena, J. Castro, C. Silva, E. Santos |
| **year** | 2012 |
